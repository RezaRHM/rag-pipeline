# Validation set v1 — live run: comparison_refactor
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `48.5s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `27.9s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `33.1s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `32.9s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `44.6s`
...
**Intent:** `troubleshooting` — **Route:** `ready` — **Time:** `35.3s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `41.4s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `37.5s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `31.5s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `41.2s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `53.3s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `49.3s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `32.2s`
...
**Intent:** `procedural` — **Route:** `ready` — **Time:** `63.0s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `52.3s`
...
**Intent:** `standard` — **Route:** `ready` — **Time:** `87.1s`
...
**Intent:** `troubleshooting` — **Route:** `ready` — **Time:** `47.3s`
...
**Intent:** `procedural` — **Route:** `ready` — **Time:** `37.2s`
...
**Intent:** `procedural` — **Route:** `ready` — **Time:** `59.6s`
...
**Intent:** `troubleshooting` — **Route:** `ready` — **Time:** `61.4s`
...
**Intent:** `comparison` — **Route:** `ready` — **Time:** `173.3s`
...
**Intent:** `comparison` — **Route:** `needs_clarification` — **Time:** `10.4s`
...
**Intent:** `comparison` — **Route:** `ready` — **Time:** `109.3s`
